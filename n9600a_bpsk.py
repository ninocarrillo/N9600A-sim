...
def FullProcess(state):
	...
	try:
		...
		audio = np.rint(audio >> (16 - FilterDecimator['InputBitCount']))
	except:
	...
	BPSKDemodulator[1] = DemodulateBPSK2(BPSKDemodulator[1])
	print(f'Done.')
